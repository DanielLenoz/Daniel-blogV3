          ...
          return (
            ...
            >
              <section className="relative">
                ...
                <div className="diamond absolute h-48 w-44 -bottom-24 -left-24"></div>
              </section>
              <section className="grid z-10">
                <h1 className=" text-center font-oswald text-xl font-bold">
                  {blog.title}
                </h1>
                <p className=" font-oscald text-base font-bold">
                  {blog.hashtag}
                </p>
                ...
                <article className="flex justify-between">
                  <NavLink className="gradient-leer font-roboto text-base font-normal">
                    Leer mas
                  </NavLink>
